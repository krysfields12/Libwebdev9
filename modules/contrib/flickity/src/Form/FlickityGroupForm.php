...
class FlickityGroupForm extends EntityForm {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $form['auto_play_enabled'] = array(
      '#type' => 'checkbox',
      '#title' => $this->t('Auto play'),
      '#default_value' => !empty($settings['auto_play']),
    ...
    $form['auto_play'] = array(
      ...
      '#description' => $this->t('Advance cells every X milliseconds. Set to 0 to disable auto play. Default is 3000 milliseconds.'),
      '#states' => array(
        'visible' => array(
          ':input[name="auto_play_enabled"]' => array('checked' => TRUE),
        ),
      ),
    );
    // Extra
