...
class __TwigTemplate_2d834ddb82aa1c4830e140eff021ac6b7beaa687a7b8d1864f2124d3a00f7e2c extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["icon"] ?? null) && ($context["icon_position"] ?? null)) &&  !($context["icon_only"] ?? null))) ? (("icon-" . $this->sandbox->ensureToStringAllowed(($context["icon_position"] ?? null), 30, $this->source))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/bootstrap/templates/input/input--button.html.twig", "/var/www/html/libraries-towson-edu/themes/contrib/bootstrap/templates/input/input--button.html.twig");
    }
